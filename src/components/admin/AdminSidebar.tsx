...
import {
  ...
  Image, Star, Settings, LogOut, ChevronRight, UserCog, X, Table2, Crown, Radio, BarChart2
} from 'lucide-react'
...
const navItems = [
  ...
  { href: '/admin/canli-yayin', icon: Radio, label: 'Canlı Yayın' },
  { href: '/admin/trafik-analitigi', icon: BarChart2, label: 'Trafik Analitiği' },
]
